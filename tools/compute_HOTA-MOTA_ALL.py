...
if __name__ == '__main__':
    directory1 = r'/data/dcy/MultiUAV/ValLabels'  # ValLabels ValLabels_maneuver ValLabels_occlusion
    directory2 = r'/home/dcy/small_target_detection/Tracking/MYTracker/tracker/output/predict/cost_NWD'
    output_folder = r'/home/dcy/small_target_detection/Tracking/MYTracker/tracker/output/predict/cost_NWD/combined_metrics'
