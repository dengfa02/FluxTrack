...
video_name = "MultiUAV-238"
# 输入文件路径
video_path = fr"/data/dcy/MultiUAV/TestVideos/{video_name}.mp4"  # 视频文件路径
gt_path = fr"../output/predict_org/{video_name}.txt"     # 标注文件路径
output_dir = fr"/home/dcy/small_target_detection/Tracking/MultiUAV_Baseline_code_and_submissi/output/video"  # 输出目录
...
out = cv2.VideoWriter(os.path.join(output_dir, f'Track_{video_name}.mp4'), fourcc, fps, (frame_width, frame_height))
